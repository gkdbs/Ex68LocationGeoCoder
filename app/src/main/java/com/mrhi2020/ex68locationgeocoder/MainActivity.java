package com.mrhi2020.ex68locationgeocoder;
...
public class MainActivity extends AppCompatActivity {
    ...
    public void clickBtn(View view) {
        ...
        //지오코딩 정보를 구글서버에서 받아오기 무조건 예외처리 필요 - 인터넷 퍼미션 필요
        try {
            ...
            //구글지도에 보여 주기 위해 검색된 위도,경도 중 1개들 멤버변수로 대입
    ...
    public void clickShowMap(View view) {
        // 구글지도 앱을 실행하여 검색된 자표를 보여주기..

        Intent intent= new Intent();
        intent.setAction(Intent.ACTION_VIEW);

        //Uri uri= Uri.parse("geo:"+lat+","+lng+"?z=16");//마커없이
        Uri uri= Uri.parse("geo:"+lat+","+lng+"?q="+lat+","+lng+"("+address+")"+"&z=10");//마커있는것
        intent.setData(uri);
